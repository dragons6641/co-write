module.exports = {
    ...
    html += `
      ...
      list = list+'</ul>';
      return list;
    },Annotation2:function(leng,content){
      var i = 0;
      var html = `<!DOCTYPE html>
      <html lang="en">
      <!-- Start Head -->
      ...
      // for (i = 0 ; i< leng ; i++){
      //   html +=`
      //   var myElem${i+1} = document.getElementById('mytextarea${i+1}');
      //   myElem${i+1}.value = 'wowfuck'; 

      //   `
      // }
      // console.log(content[0].solution);
      ...
      `
      return html;
    }, My_page:function(leng1,leng2, content1, content2){
      var i=0;
      var j=0;
      var html = `
      <!DOCTYPE html>
      ...
      for(j = 0; j < leng2; j++){
        ...
        <div data-layout="_r" class="nopadding">
          <div data-layout="al16 ch6 ec4" class="MOD_CTABAR_BtnContainer">
            ...
            <input type = "submit" class ="btn" name = ${i+j+1} value = '${content1[j].school} ${content1[j].year}년 논술'>
            </from>
          </div>
        </div>
      </section>
      ...
      `
      return html;
      }, My_page2:function(leng1,leng2, content1, content2){
      var i=0;
      var j=0;
      var html = `
      <!DOCTYPE html>
            ...
            <div class="AP_accordion" role="tablist">
              ...
              while(i<leng2){
                if(content2[i].count === 1){
                  html +=`
                  <p class="AP_accordion_tab" role="tab" data-theme="_bgp" tabindex="0">${content2[i].id}의 첨삭</p>              
                  `
                }
                html +=`
                <div class="AP_accordion_panel" role="tabpanel">
                <p>
                  ${content2[i].advise_content}
                </div>
                `
                i++;
              }
  ...
  // list template에도 수정이 많이 필요할 것이고,
  // 각종 template이 더 보여야 할 것인다.