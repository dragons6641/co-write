module.exports = {
    ...
    html += `
    ...
    },Annotation2:function(leng,content,name){
      var i = 0;
      var html = `<!DOCTYPE html>
      <html lang="en">
      <!-- Start Head -->
      ...
      `
      return html;
    }, My_page:function(leng1, leng2, content1, content2, name){
      var i=0;
      var j=0;
      var html = `
      <!DOCTYPE html>
      ...
      }, My_page2:function(leng1,leng2, content1, content2,name){
      var i=0;
      var j=0;
      var html = `
      <!DOCTYPE html>
      ...
      My_page3:function(leng1,leng2, content1, content2,name){
        var i=0;
        var j=0;
        var html = `
        <!DOCTYPE html>
